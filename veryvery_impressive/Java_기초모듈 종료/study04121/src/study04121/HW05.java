...
public class HW05 {
	...
	public static void main(String[] args) {
		...
		////////////////////////////////////////////////////////////////////////
		// #5. 리포팅연습(영수증 출력 등) 5번 / 2125341020안규원
		// 영수증 출력 2
		////////////////////////////////////////////////////////////////////////
		...
		String[] k20_name_Array = new String[] { "퓨어에어 비말차단용마스크(최고급형)", "슬라이드식명찰 (최고급 가로형)", "매직흡착 인테리어후크(알루미늄타입)" };
		...
		int k20_tax_iPrice = (int) Math.ceil(k20_iPrice * k20_tax / (k20_tax + 1)); // 세금을 저장하는 변수
		...
		System.out.printf("=========================================\n"); // 줄로 구분
		System.out.printf("       교환/환불 14일(%s월%s일)이내,\n", k20_sdt2.format(k20_cal2.getTime()), k20_sdt3.format(k20_cal2.getTime())); // 텍스트 출력
		...
		System.out.printf("승인번호 77982843(0) %s  %10s\n", "승인금액", k20_df.format(k20_iPrice));
		// 승인금액 출력
		System.out.printf("=========================================\n"); // 줄로 구분
